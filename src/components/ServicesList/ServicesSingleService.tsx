...
const ServicesSingleService = ({
  ...
  return (
    <a
      href={`/usluge/${id}`}
      className="flex cursor-pointer flex-col items-center justify-center gap-1 text-center duration-200 hover:scale-[102%]"
    >
...
export default ServicesSingleService;
